...
файл с расчетным заданием находится в директории: Nerual_Rabbit_0:\Destination_files 
...
Список доступных моделей можно посмотреть в директории: Nerual_Rabbit_0:\Service_files\Models.
